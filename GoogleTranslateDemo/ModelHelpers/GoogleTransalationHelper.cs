...
namespace GoogleTranslateDemo.ModelHelpers
{
    public class GoogleTransalationHelper
    {
        ...
        public ResultObject LanguageTranslation(TranslationViewModel translationModel)
        {
        ...
        private ResultObject LanguageTranslationByClientLibrary(TranslationViewModel translationModel, string googleEnvironmentName, string googleEnvironmentValue)
        {
            ResultObject resultObject = new ResultObject() { Ok = false };
        ...
        private ResultObject LanguageTranslationByREST(TranslationViewModel translationModel, string googleTranslationUrl, string googleTranslationKey)
        {
            ResultObject resultObject = new ResultObject() { Ok = false };
