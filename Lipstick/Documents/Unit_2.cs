namespace Lipstick.Documents
{
    public class Unit_2
    {
        #region Building Views
        /*
         * 
         * 
         * 
         * Chung ta se phan tich du an. Xem minh se co bao nhieu trang
         * 
         * Vi sao phai phan tich du an?
         * Sau khi chung ta nhan duoc ban thiet ke tu file xd or figma
         * Chung ta se bat dau chuyen doi file thiet ke thanh code 
         * Tiep theo chung ta thuoc hien xu ly logic
         * 
         * Phan 1: Tim hieu ve View va html taghelper
         ...
         * 
         * 
         * Phan 3: Tim hieu ve Partial View, view Component
